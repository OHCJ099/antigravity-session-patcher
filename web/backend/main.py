...
async def lifespan(app: FastAPI):
    """应用生命周期"""
    # 启动时
    safe_print("🚀 Antigravity Session Patcher Web UI 启动中...")
    yield
    # 关闭时
    safe_print("👋 Antigravity Session Patcher Web UI 已关闭")


app = FastAPI(
    title="Antigravity Session Patcher",
    description="清理 Antigravity Desktop / Codex / Claude / OpenCode 会话中的拒绝回复与推理缓存",
    version=__version__,
    lifespan=lifespan
)
