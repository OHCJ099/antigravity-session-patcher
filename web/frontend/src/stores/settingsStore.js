...
export const useSettingsStore = defineStore('settings', () => {
  ...
  const antigravityEnabled = ref(localStorage.getItem('antigravityEnabled') !== 'false')
  ...
  function setAntigravityEnabled(val) {
    antigravityEnabled.value = val
    localStorage.setItem('antigravityEnabled', val ? 'true' : 'false')
  }
