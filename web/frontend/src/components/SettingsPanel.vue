  ...
  <div class="settings-panel">
    <n-space vertical size="large">
      ...
      <n-card :title="$t('settings.platformSupport')" size="small">
        <n-space vertical>
          <n-form-item :label="$t('settings.antigravityEnabled')">
            <n-switch
              :value="settingsStore.antigravityEnabled"
              @update:value="settingsStore.setAntigravityEnabled"
            />
            <template #feedback>
              <span class="form-hint">{{ $t('settings.antigravityEnabledHint') }}</span>
            </template>
          </n-form-item>
